...
export default function NegociacionesPage() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/negociaciones/${deleteId}`, {
        method: 'DELETE',
      });
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            {/* Modal panel */}
            <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 dark:bg-gray-800">
              <div className="sm:flex sm:items-start">
                ...
                <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto bg-red-100 rounded-full sm:mx-0 sm:h-10 sm:w-10 dark:bg-red-900">
                  <svg className="w-6 h-6 text-red-600 dark:text-red-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 dark:text-gray-300">
                      ¿Estás seguro de que deseas eliminar esta negociación? Esta acción no se puede deshacer y eliminará permanentemente todos los datos asociados.
                    </p>
                  </div>
                </div>
              </div>
